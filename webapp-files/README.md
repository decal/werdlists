...
| [cmsfuzz-misc-files](cmsfuzz-misc-files.txt.xz) | file names commonly found on Content Management Systems taken from the `others/misc.txt` file distributed with [CMSFuzz](https://github.com/nahamsec/CMSFuzz "Fuzzer for wordpress, cold fusion, drupal, joomla, and phpnuke.") 
